              ...
              <form>
                ...
                <div class="d-flex justify-content-center">
                 <Link to="/login"> <button type="button"
                    class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Register</button></Link>
                </div>

               <Link to="/login"> <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="#!"
